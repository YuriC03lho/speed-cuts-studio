...
const skills = [
  ...
  { icon: Crosshair, name: "GAME EDITS", level: 90, desc: "Sync · Beat drops", size: "lg", targetId: "01,02" },
  { icon: Film, name: "Storytelling", level: 90, desc: "Ritmo · Narrativa", size: "md", targetId: "05,04" },
];
